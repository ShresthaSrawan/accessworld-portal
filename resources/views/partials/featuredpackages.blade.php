        ...
        <div class="card card-type-pricing text-center" itemscope itemtype="http://schema.org/Product">
          ...
          <span>
            ...
            <div class="card-body style-gray">
                ...
                <div class="price">
                    <div>@if($hasDiscount)<s>{{ ($package->price) }}</s> @endif</div>
                    <h2><span class="text-xs"
                              itemprop="priceCurrency"
                              content="get_local_currency_code()">{{ site('currency') }}</span> <span class="text-lg"
                                                                                                      itemprop="price">{{ $package->discounted_price }}</span>
                    </h2> <span>/mo</span>
                </div>
                <br />
            </div><!--end .card-body -->
            ...
            <div class="card-body">
                <a class="btn btn-raised ink-reaction btn-accent"
                   href="{{ route('service.package.order', ['vps', $package->slug]) }}">Get quote</a>
            </div><!--end .card-body -->
        </div><!--end .card -->
    </div><!--end .col -->
@endforeach
    ...
    <div class="col-md-3">
        <div class="card card-type-pricing text-center" itemscope itemtype="http://schema.org/Product">
          ...
          <span>
            ...
            <div class="card-body style-gray">
                ...
                <div class="price">
                    ...
                    <h2><span class="text-xs"
                        ...
                        <span class="text-lg" itemprop="price">{{ $package->price }}</span></h2> <span>/mo</span>
                </div>
                <br />
            </div><!--end .card-body -->
            <div class="card-body no-padding" itemprop="description">
            ...
            <div class="card-body">
                <a class="btn btn-raised ink-reaction btn-accent"
                   href="{{ route('service.web.create', $package->slug) }}">Get quote</a>
            </div><!--end .card-body -->
        </div><!--end .card -->
    </div><!--end .col -->
@endforeach
        ...
        <div class="card card-type-pricing text-center" itemscope itemtype="http://schema.org/Product">
          ...
          <span>
            ...
            <div class="card-body style-gray">
                ...
                <div class="price">
                    <div>@if($hasDiscount)<s>{{ currency($package->price) }}</s> @endif</div>
                    <h2><span class="text-xs"
                              itemprop="priceCurrency"
                              content="get_local_currency_code()">{{ site('currency') }}</span> <span class="text-lg"
                                                                                                      itemprop="price">{{ $package->price }}</span>
                    </h2> <span>/mo</span>
                </div>
                <br />
            </div><!--end .card-body -->
            ...
            <div class="card-body">
                <a class="btn btn-raised ink-reaction btn-accent"
                   href="{{ route('service.email.create', $package->slug) }}">Get quote</a>
            </div><!--end .card-body -->
        </div><!--end .card -->
    </div><!--end .col -->
@endforeach