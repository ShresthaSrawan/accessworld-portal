<div class="card">
    <div class="card-body">
        ...
        <div class="row">
            <div class="col-sm-4">
                <div class="form-group">
                    <input type="text" class="form-control" id="domain" value="{{ $emailPackage->domain }} Domain(s)" readonly>
                    <label for="domain">Domain</label>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <input type="text" class="form-control" id="disk" value="{{ $emailPackage->disk }} GB" readonly>
                    <label for="disk">Storage</label>
                </div>
            </div>
            <div class="col-sm-4">
                <div class="form-group">
                    <input type="text" class="form-control" id="traffic" value="{{ $emailPackage->traffic }} GB" readonly>
