...
@section('og:title', 'Web Hosting Services')
        ...
        <div class="container">
            <div class="row">
                <div class="animated fadeInUp text-center">
                    <h2 class="text-medium">Web Hosting</h2>
                    <div class="section-title-line"></div>
                    <p>Choose from the packages <a href="#service-packages" class="text-primary">below</a>
                     {{-- or create a <a href="{{ route('service.web.custom.create') }}" class="text-primary">custom one</a></p> --}}
                </div>
                        ...
                        <div class="col-xs-6 col-md-3">
                            <div class="card card-type-pricing text-center">
                                ...
                                <div class="card-body {{ $active }}">
                                    ...
                                    @if($hasDiscount)<div>Starting at <s>{{ get_local_price(monthly_to_annual($package->price)) }}</s></div>@endif
                                    <p class="text-lg text-default-bright" itemprop="name"><em>Web Hosting</em></p>
                                    <div class="price text-default-bright">
                                        ...
                                        <h2><span class="text-lg"
                                                  itemprop="price">{{ get_local_price(monthly_to_annual($package->discounted_price), true) }}</span>
                                        </h2> <span>/y</span>
                                    </div>
                                    <br/>
                                </div><!--end .card-body -->
                                ...
                                <div class="card-body">
                                    <a href="{{ route('service.web.create', $package->slug) }}"
