@if(!$invoice->domainOrders->isEmpty())
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;" valign="top">
            ...
            <p>
                Congratulations! you have successfully purchased <strong>{{ $invoice->domainOrders->implode('domain', ', ') }}</strong>
            </p>
            <p>
                Below mentioned are your domain details:
            </p>
        </td>
    </tr>
    ...
    <tr style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; margin: 0;">
        <td style="font-family: 'Helvetica Neue',Helvetica,Arial,sans-serif; box-sizing: border-box; font-size: 14px; vertical-align: top; margin: 0; padding: 5px 0;" valign="top">
            <p>To manage your domain login to <a href="accessworld.net" target="_blank">AccessWorld</a></p>
        </td>
    </tr>
@endif