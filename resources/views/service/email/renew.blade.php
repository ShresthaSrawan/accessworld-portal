{{ Form::open(['route' => ['manageemail.renewPost', $provision->name], 'class' => 'form renewForm']) }}
{{--*/ $offer = has_offer('email'); /**--}}
    ...
    <div class="col-sm-12">
        <div class="price">
            @foreach($prices as $term => $price)
                ...
                <h2 class="email-renew-price{{ $isVisible ? '' : ' hidden' }}" data-term="{{ $term }}">
