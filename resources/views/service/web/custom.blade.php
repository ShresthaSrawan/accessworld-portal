    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-10 col-xs-offset-1 col-md-8 col-md-offset-2"> 
          {{ Form::open([ 'route' => 'service.web.custom.store', 'class' => 'form form-validate', 'novalidate' , 'data-url' => route('service.web.custom.price'), 'id' => 'form-custom-plan']) }}
            <div class="card">
              <div class="card-head">
                <header class="custom-title">Make a Web Hosting Custom Plan</header>
              </div>
