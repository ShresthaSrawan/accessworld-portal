...
namespace {
    ...
    class Cart extends \App\Facades\Cart{
        ...
        public static function instance($instance = null){
            return \App\Awt\Cart\CartService::instance($instance);
        }
         ...
         * @static 
         */
        public static function add($name, $qty = null, $discount = null, $price = null, $options = array()){
            return \App\Awt\Cart\CartService::add($name, $qty, $discount, $price, $options);
        }
        ...
        public static function update($rowId, $attribute){
            return \App\Awt\Cart\CartService::update($rowId, $attribute);
        }
        ...
        public static function content(){
            return \App\Awt\Cart\CartService::content();
        }
        ...
        public static function get($rowId){
            return \App\Awt\Cart\CartService::get($rowId);
        }
        ...
        public static function count($totalItems = true){
            return \App\Awt\Cart\CartService::count($totalItems);
        }
        ...
        public static function total(){
            return \App\Awt\Cart\CartService::total();
        }
        ...
        public static function remove($rowId){
            return \App\Awt\Cart\CartService::remove($rowId);
        }
        ...
        public static function destroy(){
            return \App\Awt\Cart\CartService::destroy();
        }
         ...
         * @static 
         */
        public static function discountedTotal(){
            return \App\Awt\Cart\CartService::discountedTotal();
        }
         ...
         * @static 
         */
        public static function vatTotal($vat){
            return \App\Awt\Cart\CartService::vatTotal($vat);
        }
    ...
    class Asa extends \App\Facades\Asa{
        
        /**
         * 
         *
         * @return \App\Awt\Asa\Client 
         * @throws \Exception
         * @static 
         */
        public static function connect(){
            return \App\Awt\Asa\AsaService::connect();
        }
        ...
        public static function getBaseURI(){
            return \App\Awt\Asa\AsaService::getBaseURI();
        }
        ...
        public static function setBaseURI($baseURI){
            return \App\Awt\Asa\AsaService::setBaseURI($baseURI);
        }
         ...
         * @static 
         */
        public static function login($resellerId = false, $emailAddress = false, $password = false){
            return \App\Awt\Asa\AsaService::login($resellerId, $emailAddress, $password);
        }
        ...
        public static function getResellerId(){
            return \App\Awt\Asa\AsaService::getResellerId();
        }
         ...
         * @static 
         */
        public static function setResellerId($resellerId){
            return \App\Awt\Asa\AsaService::setResellerId($resellerId);
        }
        ...
        public static function getEmailAddress(){
            return \App\Awt\Asa\AsaService::getEmailAddress();
        }
        ...
        public static function setEmailAddress($emailAddress){
            return \App\Awt\Asa\AsaService::setEmailAddress($emailAddress);
        }
         ...
         */
        public static function getPassword(){
            return \App\Awt\Asa\AsaService::getPassword();
        }
        ...
        public static function setPassword($password){
            return \App\Awt\Asa\AsaService::setPassword($password);
        }
         ...
         * @static 
         */
        public static function getResponse($raw = false){
            return \App\Awt\Asa\AsaService::getResponse($raw);
        }
         ...
         * @static 
         */
        public static function addToCart($description, $periodMonths, $qty = 1){
            return \App\Awt\Asa\AsaService::addToCart($description, $periodMonths, $qty);
        }
         ...
         * @static 
         */
        public static function getResellerPricings($periodMonths = false, $purchaseType = 'SUBSCRIBE'){
            return \App\Awt\Asa\AsaService::getResellerPricings($periodMonths, $purchaseType);
        }
        ...
        public static function getAccessToken(){
            return \App\Awt\Asa\AsaService::getAccessToken();
        }
        ...
        public static function setAccessToken($accessToken){
            return \App\Awt\Asa\AsaService::setAccessToken($accessToken);
        }
         ...
         * @static 
         */
        public static function getResellerDomain(){
            return \App\Awt\Asa\AsaService::getResellerDomain();
        }
        ...
        public static function getCart(){
            return \App\Awt\Asa\AsaService::getCart();
        }
        ...
        public static function getUserId(){
            return \App\Awt\Asa\AsaService::getUserId();
        }
        ...
        public static function setUserId($userId){
            return \App\Awt\Asa\AsaService::setUserId($userId);
        }
        ...
        public static function removeFromCart($cartItemId){
            return \App\Awt\Asa\AsaService::removeFromCart($cartItemId);
        }
        ...
        public static function getNameServers(){
            return \App\Awt\Asa\AsaService::getNameServers();
        }
         ...
         * @static 
         */
        public static function setResellerDomains($domain){
            return \App\Awt\Asa\AsaService::setResellerDomains($domain);
        }
         ...
         * @static 
         */
        public static function createDomainContact($data, $type){
            return \App\Awt\Asa\AsaService::createDomainContact($data, $type);
        }
         ...
         * @static 
         */
        public static function createCustomerAccount($email, $password, $firstName, $lastName){
            return \App\Awt\Asa\AsaService::createCustomerAccount($email, $password, $firstName, $lastName);
        }
        ...
        public static function resendVerificationEmail(){
            return \App\Awt\Asa\AsaService::resendVerificationEmail();
        }
         ...
         * @static 
         */
        public static function getTLDSettings(){
            return \App\Awt\Asa\AsaService::getTLDSettings();
        }
        ...
        public static function checkAvailability($domain){
            return \App\Awt\Asa\AsaService::checkAvailability($domain);
        }
        ...
        public static function createOrder(){
            return \App\Awt\Asa\AsaService::createOrder();
        }
        
    }


    class OpenSrs extends \App\Facades\OpenSrs{
         ...
         * @static 
         */
        public static function domainCheckAvailability($domain){
            return \App\Services\OpenSrsService::domainCheckAvailability($domain);
        }
         ...
         * @static 
         */
        public static function domainNameSuggest($domain, $selectedTld){
            return \App\Services\OpenSrsService::domainNameSuggest($domain, $selectedTld);
        }
         ...
         * @static 
         */
        public static function getPrice($domain, $period){
            return \App\Services\OpenSrsService::getPrice($domain, $period);
        }
         ...
         * @static 
         */
        public static function provisionDomain($item){
            return \App\Services\OpenSrsService::provisionDomain($item);
        }
